 ...
 */
#define BOARD_UNIQUE_ID "a890939854a18a4a"

/**
 * @brief Defines if is a CENTRAL or NODE device.
 */
#define BOARD_TYPE "central"

/**
 * @brief Defines the unique sensor type identifier for this board
 */
#define BOARD_SENSOR_TYPE "panel.relay.control"
